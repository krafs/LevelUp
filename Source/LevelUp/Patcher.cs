...
namespace LevelUp
{
    public static class Patcher
    {
        ...
        {
            MethodInfo SkillRecordLearnMethod = AccessTools.Method(typeof(SkillRecord), nameof(SkillRecord.Learn));
            MethodInfo SkillRecordLearnTranspilerMethod = AccessTools.Method(typeof(Patcher), nameof(LearnTranspilerPatch));
